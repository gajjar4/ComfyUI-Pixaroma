...
_H3_PROMPT_CLASS = "PixaromaH3Prompt"
...
def _walk_for_text(
    ...
    # Minimax H3 Prompt Pixaroma: return the user's IDEA.
    #
    ...
    # finds H3PromptState is not a text key, and reports nothing at all.
    if cls == _H3_PROMPT_CLASS:
        raw = inputs.get("H3PromptState")
        idea = ""
