...
class PixaromaSaveVideo:
    DESCRIPTION = (
        ...
        "The workflow is embedded in the saved mp4, so you can drag the video back into "
        "ComfyUI to rebuild the graph. Reading it back needs a video pack such as "
        "VideoHelperSuite installed; saving it always works.\n\n"
