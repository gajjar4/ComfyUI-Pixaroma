  ...
  sections: [
    ...
    },
    {
      ...
      body:
        ...
        + "Around a minute, Auto states the verse count outright rather than "
        + "leaving it to be inferred, because that is the one length where it was "
        + "measured to get ignored: a minute-long song kept coming back with the "
        + "one verse and one chorus of a thirty second one. Naming it took that "
        + "from three runs in five filling the minute to five in five.\n\n"
