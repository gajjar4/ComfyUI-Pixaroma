...
export const KEYWORDS = {
  ...
  PixaromaH3Prompt: "h3 minimax minimax h3 prompt writer write my prompt video prompt llm local llm qwen qwen3 vl vision model text to video first frame last frame fflf first and last frame image to video prompt generator prompt helper describe the picture soundscape dialogue talking speech what do i type stop copy pasting from chatgpt formula length 5 seconds 8 seconds 10 seconds 15 seconds",
