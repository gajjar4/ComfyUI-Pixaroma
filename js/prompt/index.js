  ...
  sections: [
    ...
    },
    {
      ...
      body:
        ...
        "Deleting is safe to try. The bin on a card removes that tag at once and an `Undo` strip appears at the bottom; `Ctrl+Z` undoes too, for as long as the library is open. The `...` on a category row (or a right-click on it) offers rename, export just that category, delete the category but keep its tags, or delete it with them. The `...` beside Export and Import has `Delete everything` for a clean start. Anything that removes more than one tag asks first and offers to save you a backup file.\n\n" +
